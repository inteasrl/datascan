import{a as c}from"./ProgramTemplate-BuCF-5KS.js";import{E as g,e as y,o as j,b as F}from"./ProgramTemplate-BuCF-5KS.js";import{R as A,s as O}from"./FramebufferObject-Rp5H69Q0.js";import{dA as w}from"./dati-BGDeNIdh.js";import{t as p}from"./NestedMap-BwbkO4RU.js";import"./memoryEstimations-kOT_zz4V.js";import"./style-DHUQkZzN.js";class x{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function b(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
